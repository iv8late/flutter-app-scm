...
import 'package:project_base_app/auth/transition_route_observer.dart';
import 'package:project_base_app/widgets/animated_numeric_text.dart';
import 'package:project_base_app/widgets/fade_in.dart';
import 'package:project_base_app/widgets/round_button.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  void initState() {
    ...
    _headerScaleAnimation = Tween<double>(begin: .6, end: 1).animate(
      CurvedAnimation(parent: _loadingController!, curve: headerAniInterval),
    );
  }
  ...
  Widget _buildHeader(ThemeData theme) {
    ...
    final linearGradient = LinearGradient(
      colors: [primaryColor.shade800, primaryColor.shade200],
      ...
      children: [
        ...
        _buildButton(
          icon: Container(
            ...
            child: const Icon(FontAwesomeIcons.moneyBill1, size: 20),
          ),
          label: 'Fund Transfer',
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    Expanded(flex: 2, child: _buildHeader(theme)),
                    Expanded(
                      flex: 8,
                      child: ShaderMask(
